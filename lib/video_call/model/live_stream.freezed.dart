...
mixin _$LiveStream {
 ...
 String? get id; String? get user_id; String? get title; String? get description; String? get channel_name; DateTime? get created_at; DateTime? get ended_at; bool? get is_active; String? get thumbnail_url; int? get viewer_count; Account? get user;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,user_id,title,description,channel_name,created_at,ended_at,is_active,thumbnail_url,viewer_count,user);

@override
String toString() {
  return 'LiveStream(id: $id, user_id: $user_id, title: $title, description: $description, channel_name: $channel_name, created_at: $created_at, ended_at: $ended_at, is_active: $is_active, thumbnail_url: $thumbnail_url, viewer_count: $viewer_count, user: $user)';
}
...
@useResult
$Res call({
 String? id, String? user_id, String? title, String? description, String? channel_name, DateTime? created_at, DateTime? ended_at, bool? is_active, String? thumbnail_url, int? viewer_count, Account? user
});
...
/// Create a copy of LiveStream
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? user_id = freezed,Object? title = freezed,Object? description = freezed,Object? channel_name = freezed,Object? created_at = freezed,Object? ended_at = freezed,Object? is_active = freezed,Object? thumbnail_url = freezed,Object? viewer_count = freezed,Object? user = freezed,}) {
...
as bool?,thumbnail_url: freezed == thumbnail_url ? _self.thumbnail_url : thumbnail_url // ignore: cast_nullable_to_non_nullable
...
class _LiveStream implements LiveStream {
  const _LiveStream({required this.id, required this.user_id, required this.title, this.description, required this.channel_name, required this.created_at, this.ended_at, required this.is_active, this.thumbnail_url, required this.viewer_count, this.user});
